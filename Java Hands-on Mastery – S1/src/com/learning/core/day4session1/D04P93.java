...
public class D04P93 {
	...
	public static void main(String[] args) {
		...
		D04P93 s = new D04P93();
		 System.out.println(s. evaluate("10 + 2 * 6"));
		 System.out.println(s.evaluate("33 * 2 + 12"));
		 System.out.println(s.evaluate("20 * ( 6 + 55 )"));
		 System.out.println(s.evaluate("100 * ( 2 + 120 ) * 140"));
	}
